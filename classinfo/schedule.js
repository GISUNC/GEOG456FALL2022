var GEOG456 = {
    ...
    topics:[
        ...
        {topic:'Google Earth Engine to observe coarse scale landscape changes',
                ...
                hw:[{title:'Make an interactive GEE map', deadline:'before next2 class', value:10, rubric:{'Interactive component':3, 'Histogram matched at least 2 images of different time':2, 'the layers have a proper name and not a default value':1, 'The student put into context the observed changes':2, 'The presentation was within the alloted time and the student made an effective presentation':2 },description:'Watch the video on how to create a GEE map and make it public. Make a map with in your account. The map should have a title and the layers should have a proper name and not the default `layer` value'},
                ]},
